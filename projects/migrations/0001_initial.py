# Generated by Django 4.2.7 on 2023-11-11 04:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenges', models.CharField(blank=True, default=None, max_length=80, null=True)),
                ('progress_update', models.CharField(blank=True, default=None, max_length=80, null=True)),
                ('assign', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
